							...
							<xsl:choose>
								<xsl:when test="string($sort)">
									<li class="ui-state-default ui-corner-all">
										<a class="pagingBtn" href="?q={encode-for-uri($q)}&amp;start={$previous}&amp;sort={$sort}">«</a>
									</li>
									
								</xsl:when>
								<xsl:otherwise>
									<li class="ui-state-default ui-corner-all">
										<a class="pagingBtn" href="?q={encode-for-uri($q)}&amp;start={$previous}">«</a>
									</li>
								</xsl:otherwise>
							</xsl:choose>
					...
					<xsl:choose>
						<xsl:when test="$numFound - $start_var &gt; $rows">
							<xsl:choose>
								<xsl:when test="string($sort)">
									<li class="ui-state-default ui-corner-all">
										<a class="pagingBtn" href="?q={encode-for-uri($q)}&amp;start={$next}&amp;sort={$sort}">»</a>
									</li>
								</xsl:when>
								<xsl:otherwise>
									<li class="ui-state-default ui-corner-all">
										<a class="pagingBtn" href="?q={encode-for-uri($q)}&amp;start={$next}">»</a>
									</li>
								</xsl:otherwise>
							</xsl:choose>
						</xsl:when>
