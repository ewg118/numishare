...
$(document).ready(function () {
    ...
    '<div class="row membership-banner-container">' +
    '<div class="col-md-2 text-center"><a href="http://numismatics.org/membership/"><img src="http://numismatics.org/themes/ocre/images/ans-logo-inverse.png" alt="ANS Logo" class="membership-banner-logo"/></a></div>' +
