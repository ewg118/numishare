			...
			<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:numishare="https://github.com/ewg118/numishare">
				...
				<xsl:variable name="facet">
					<xsl:choose>
						...
						<xsl:when test="matches(doc('input:request')/request/request-url, 'subjects\.(kml|geojson)')">subject_geo&amp;facet.field=issuePlace_geo</xsl:when>
						<xsl:otherwise>mint_geo&amp;facet.field=productionPlace_geo&amp;facet.field=findspot_geo&amp;facet.field=hoard_geo&amp;facet.field=subject_geo&amp;facet.field=issuePlace_geo</xsl:otherwise>
					</xsl:choose>
				</xsl:variable>
