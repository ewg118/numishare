	...
	<xsl:template name="index">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-9">
					...
					<p>The ANS collections database contains information on more than 600,000 objects in the Society’s collections. These include coins, paper money, tokens,
						‘primitive’ money, medals and decorations, from all parts of the world, and all periods in which such objects have been produced. Read more about the
						collection <a href="https://numismatics.org/collections/">here</a>.</p>


					<form role="search" style="margin:20px 0;" action="{$display_path}results" method="get">
						<h3>Search the Collection</h3>
						<div class="input-group">
							<input type="text" class="form-control" placeholder="{numishare:normalizeLabel('header_search', $lang)}" name="q"/>
						...
						<div>
							<small>
								<a href="{$display_path}search">Advanced Search Form</a>
								<xsl:text> | </xsl:text>
								<a href="{$display_path}results">Browse the Collection</a>
							</small>
						</div>
					</form>
				...
				<div id="feature" class="highlight text-center col-md-3">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6">
					<h3>Get Involved</h3>
					<p> Please consider becoming a Member of the American Numismatic Society, the publisher of this resource. Your membership helps maintain our free and open
						digital projects and data, as well as other educational outreach activities that broaden public access to numismatics. Membership comes with other benefits,
						such as the ANS Magazine and weekly virtual lectures and discussions. See <a href="http://numismatics.org/membership/">Membership</a> for more
						information.</p>
				</div>
			</div>
		</div>
