...
$(document).ready(function () {
    ...
    var template = '<div id="membership-banner"><div class="container">' +
						'<div class="row" style="height:100px;position:relative">' +
							'<div class="col-md-2 text-center"><a href="http://numismatics.org/membership/"><img src="http://localhost/themes/ocre/images/ans-logo-inverse.png" alt="ANS Logo" style="max-width:100px"/></a></div>' +
							...
							'<div class="col-md-10 visible-sm visible-xs text-center"><a href="http://numismatics.org/membership/">Support this resource by joining the American Numismatic Society as a member today!</a>' +
