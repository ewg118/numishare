	...
	<xsl:template name="footer">
		<div id="ft">
			<div class="yui3-g">
				...
				<div class="yui3-u-1-3">
					<div class="content"> This data is made available under the Open Database License: <a href="http://opendatacommons.org/licenses/odbl/1.0/"
							>http://opendatacommons.org/licenses/odbl/1.0/</a>.</div>
				</div>
				<div class="yui3-u-1-3">
					<div class="content" style="text-align:right">
						<a href="http://www.virginia.edu/artmuseum/index.php" target="_blank">The Fralin | University of Virginia Art Museum</a>
						<br/>
						<xsl:text>Thomas H. Bayly Building</xsl:text>
						<br/>
						<xsl:text>155 Rugby Road, PO Box 400119</xsl:text>
						<br/>
