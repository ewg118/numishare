					...
					<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
						...
						<xsl:variable name="service">
							<xsl:value-of
								...
								'+AND+NOT(lang:*)+AND+(coinType_uri:*+OR+hoard_uri:*)+AND+NOT(typeUncertain:true)&amp;rows=10000&amp;start=', $start, '&amp;fl=id,recordId,title_display,lot_display,coinType_uri,objectType_uri,recordType,publisher_display,axis_num,diameter_num,height_num,width_num,taq_num,weight_num,thumbnail_obv,reference_obv,thumbnail_rev,reference_rev,thumbnail_com,reference_com,iiif_obv,iiif_rev,iiif_com,findspot_uri,findspot_geo,collection_uri,hoard_uri,identifier_display,homepage_uri&amp;mode=nomisma')"
							/>
						</xsl:variable>
