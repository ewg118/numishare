...
* 10. The script now reads /data/images/files.list for a full listing of jpg files rather than relying
*   on imageavailable=true from FileMaker. files.list is generated by the nightly TIF-JPG conversion script.
*   If the nighly script is not active, files.list should be manually generated by `ls -R /data/images/collectionimages/ > /data/images/files.list`
* 11. Script is good to go.
************************/
